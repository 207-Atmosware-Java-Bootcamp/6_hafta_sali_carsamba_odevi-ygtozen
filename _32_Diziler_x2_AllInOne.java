...
// bu dizideki elemanlardan tek sayılıradan kaç tane ve tek sayıların toplamı
// (tek sayı dizisi)
// bu dizideki elemanlardan çift sayılıradan kaç tane ve çift sayıların toplamı
// (çift sayı dizisi)
// dizilerde en büyük ile ile 25'i karşılaştıralım, dizideki eleman 25'ten
// büyükmü
// dizideki elemanlarda 5 sayısı varmı ?(java.util.Arrays.binarySearch())
// dizideki tekar eden sayıları bir dizide gösterelim
// dizideki tekrar eden sayılar yerine 1 kere tekrar sayı gösterilsin(tekrarsız
// veriler)
